package com.fukaabi97.animestream
...
open class AnimeStream : MainAPI() {
    ...
    override suspend fun getMainPage(
        ...
        // Hier können die Selektoren ggf. an die Struktur von anime-stream.to angepasst werden:
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        // Passe hier die Selektoren an, falls die Website-Struktur abweicht:
        ...
        document.select("div#stream > ul:first-child li").forEach { ele ->
            ...
            val epsDocument = app.get(fixUrl(page?.attr("href") ?: return@forEach)).document
            epsDocument.select("div#stream > ul:nth-child(4) li").forEach { eps ->
                eps.selectFirst("a")?.attr("href")?.let { link ->
                    episodes.add(
                        Episode(
                            fixUrl(link),
    ...
    override suspend fun loadLinks(
        ...
        // Auch hier ggf. die Selektoren anpassen:
